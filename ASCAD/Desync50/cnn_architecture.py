...
### CNN network
def cnn_architecture(input_size=700,learning_rate=0.00001,alpha_value=10,classes=256,rkl_loss=True):
    ...
    # Create model
    inputs = img_input
    model = Model(inputs, predictions, name='cnn_best')
...
(X_profiling, Y_profiling), (X_attack, Y_attack), (plt_profiling, plt_attack) = load_ascad(ASCAD_data_folder + "ASCAD_desync50.h5", load_metadata=True)
